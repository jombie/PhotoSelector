...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
        ...
        public RecyclerViewDivider(Context context, AttributeSet attrs) {
            final TypedArray a = context.obtainStyledAttributes(attrs, new int[]{android.R.attr.listDivider});
            mDivider = a.getDrawable(0);
            a.recycle();
        }

        public RecyclerViewDivider(Context context, AttributeSet attrs, boolean showFirstDivider,
        ...
        public RecyclerViewDivider(Context context, int resId, boolean showFirstDivider,
                                     boolean showLastDivider) {
            this(context, resId);
            mShowFirstDivider = showFirstDivider;
            mShowLastDivider = showLastDivider;
        ...
        public RecyclerViewDivider(Drawable divider, boolean showFirstDivider,
                                     boolean showLastDivider) {
            this(divider);
            mShowFirstDivider = showFirstDivider;
            mShowLastDivider = showLastDivider;
